...
const METHOD = [
  ...
  },
  {
    ...
    body: "Career reconnaissance turns fear into information: study the work, ask people who know it, and compare what you learn, with no pressure to apply."
  }
];
...
const WEEKS = [
  ...
  },
  {
    ...
    theme: "The financial side of a job change, with Alyson.",
...
const STRAIN_AREAS = [
  ...
  },
  {
    ...
    examples: "Alarms · call lights · questions · messages · charting · new orders · unfinished tasks · open mental loops · constant task switching · phone and productivity pressure",
    advice: "Investigate call volume, simultaneous work queues, message volume, task switching, charting pressure, productivity measures, and how often you are pulled away from unfinished work."
  },
  {
    key: "change",
    name: "Change load",
    examples: "New technology · new charting and EHR systems · equipment · policies · staffing models · changing expectations · limited onboarding · learning while expected to perform at full speed",
